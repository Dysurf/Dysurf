...
pl1.text(-0.5,51," K ",fontsize=17)
pl1.text(0,51," $\Gamma$ ",fontsize=17)
pl1.text(0.45,51," K ",fontsize=17)
#pl1.text(0.15,17.4,"PdSe2(T=300K)",fontsize=17)
pl1.text(0.49,-7,"[H H 2](r.l.u.)",fontsize=17)
cax=pl1.imshow(pl.rot90(pl.log(data)), interpolation='bicubic', extent=[-0.5,0.5,0,50], aspect = 'auto')
#                                                                                 #width: aspect
#pl1.title("Ta (T=300K)")
pl1.set_cmap('jet')
