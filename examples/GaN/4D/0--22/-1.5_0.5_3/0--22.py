...
pl1.text(-2.45,51," $\Gamma$ ",fontsize=17)
pl1.text(-2,51," M ",fontsize=17)
pl1.text(-1.5,51," $\Gamma$ ",fontsize=17)
pl1.text(-1,51," M ",fontsize=17)
pl1.text(-0.5,51," $\Gamma$ ",fontsize=17)
#pl1.text(0.15,17.4,"PdSe2(T=300K)",fontsize=17)
pl1.text(-1,-7,"[-H H 2](r.l.u.)",fontsize=17)

cax=pl1.imshow(pl.rot90(pl.log(data)), interpolation='bicubic', extent=[-0.5,-2.5,0,50], aspect = 'auto')
#                                                                                 #width: aspect
#pl1.title("Ta (T=300K)")
pl1.set_cmap('jet')
