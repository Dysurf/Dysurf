...
sqebin = N.loadtxt(fname+".dat")
sqebin = N.transpose(sqebin)
sqebin = N.reshape(sqebin,[101,10,10,10],order='F')
pl1.interactive(True)
pl1.ylabel('Energy (meV)',fontsize=12)
cax=pl1.imshow(pl.rot90(pl.log(sqebin)), interpolation='bicubic', extent=[0.0,1.0,0,50], aspect = 'auto')
pl1.set_cmap('jet')
a=1
...
#pl1.text(0,12.2," $\Gamma$ ",fontsize=17)
#pl1.text(1,12.2," X ",fontsize=17)
#pl1.text(2,12.2," $\Gamma$ ",fontsize=17)
#pl1.text(3,12.2," X ",fontsize=17)
#pl1.text(3.8,12.2," $\Gamma$ ",fontsize=17)
#pl1.text(1.5,13.2,"CsI(T=0K)",fontsize=17)
#pl1.text(1.5,-1.5,"[H00](r.l.u.)",fontsize=17)
