...
pl1.text(-3.1,51," $\Gamma$ ",font='Times New Roman',fontsize=17)
pl1.text(-2.6,51," M ",font='Times New Roman',fontsize=17)
pl1.text(-2.1,51," $\Gamma$ ",font='Times New Roman',fontsize=17)
pl1.text(-1.6,51," M ",font='Times New Roman',fontsize=17)
pl1.text(-1.1,51," $\Gamma$ ",font='Times New Roman',fontsize=17)
#pl1.text(0.15,17.4,"PdSe2(T=300K)",fontsize=17)
pl1.text(-2.5,-7,"[H-H2] (r.l.u.)",fontsize=15)
pl1.text(-2.95,46.5,"300K",fontsize=16,color='white')
