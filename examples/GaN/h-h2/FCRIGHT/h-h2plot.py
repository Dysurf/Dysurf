...
pl1.text(-3,51," $\Gamma$ ",fontsize=17)
pl1.text(-2.5,51," M ",fontsize=17)
pl1.text(-2,51," $\Gamma$ ",fontsize=17)
pl1.text(-1.5,51," M ",fontsize=17)
pl1.text(-1,51," $\Gamma$ ",fontsize=17)
#pl1.text(0.15,17.4,"PdSe2(T=300K)",fontsize=17)
pl1.text(-2.5,-7,"[H -H 2](r.l.u.)",fontsize=17)

cax=pl1.imshow(pl.rot90(pl.log(data)), interpolation='bicubic', extent=[-3.0,-1.0,0,50], aspect = 'auto')
#                                                                                 #width: aspect
#pl1.title("Ta (T=300K)")
pl1.set_cmap('jet')
