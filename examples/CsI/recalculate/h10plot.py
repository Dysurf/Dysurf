...
pl1.text(-0.1,12.2," X ",fontsize=17)
pl1.text(0.9,12.2," $\Gamma$ ",fontsize=17)
pl1.text(1.8,12.2," X ",fontsize=17)
pl1.text(2.9,12.2," $\Gamma$ ",fontsize=17)
pl1.text(3.8,12.2," X ",fontsize=17)
pl1.text(1.5,13.2,"CsI (T=0K)",fontsize=17)
pl1.text(1.5,-1.5,"[H10] (r.l.u.)",fontsize=17)
