...
pl1.text(0.5,12.2," M ",fontsize=17)
pl1.text(1,12.2," $\Gamma$ ",fontsize=17)
pl1.text(1.5,12.2," M ",fontsize=17)
pl1.text(1.9,12.2," $\Gamma$ ",fontsize=17)
pl1.text(0.75,13.2,"CsI(T=0K)",fontsize=17)
pl1.text(0.75,-1.5,"[H2+H0](r.l.u.)",fontsize=17)

cax=pl1.imshow(pl.rot90(pl.log(data)), interpolation='bicubic', extent=[0.0,2.0,0,12], aspect = 'auto')
#                                                                                 #width: aspect
#pl1.title("Ta (T=300K)")
pl1.set_cmap('jet')
