...
pl1.text(-0.02,15.2," $\Gamma$ ",fontsize=17)
pl1.text(0.46,15.2," K ",fontsize=17)
pl1.text(0.95,15.2," $\Gamma$ ",fontsize=17)
pl1.text(0.28,16.2,"TaS$_2$ (T=300K)",fontsize=17)
pl1.text(0.22,-2,"[1+H 1+H 0] (r.l.u.)",fontsize=17)

cax=pl1.imshow(pl.rot90(pl.log(data)), interpolation='bicubic', extent=[0.0,1.0,0,15], aspect = 'auto')
#                                                                                 #width: aspect
#pl1.title("Ta (T=300K)")
pl1.set_cmap('jet')
