...
pl1.text(-0.01,15.2," $\Gamma$ ",fontsize=17)
pl1.text(0.47,15.2," A ",fontsize=17)
pl1.text(0.16,16.4,"TaS$_2$ (T=300K)",fontsize=17)
pl1.text(0.14,-2,"[004+H] (r.l.u.)",fontsize=17)

cax=pl1.imshow(pl.rot90(pl.log(data)), interpolation='bicubic', extent=[0.0,0.5,0,15], aspect = 'auto')
#                                                                                 #width: aspect
#pl1.title("Ta (T=300K)")
pl1.set_cmap('jet')
