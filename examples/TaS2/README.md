...
This example uses the **espresso.fc** file generated by Quantum ESPRESSO. Note that the input parameters `clatvec` and `LATTICE_PARAMETERS` should both be given in **angstrom** units.
