...
pl1.text(-0.05,15.2," $\Gamma$ ",fontsize=17)
pl1.text(0.4,15.2," K ",fontsize=17)
pl1.text(0.9,15.2," $\Gamma$ ",fontsize=17)
pl1.text(1.4,15.2," K ",fontsize=17)
pl1.text(1.9,15.2," $\Gamma$ ",fontsize=17)
pl1.text(0.55,16.4,"TaS$_2$ (T=300K)",fontsize=17)
pl1.text(0.65,-2,"[HH4] (r.l.u.)",fontsize=17)
